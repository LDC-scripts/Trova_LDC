...
(function () {
    ...
    const CSV_URL       = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQtBU-lbL5JMTtqWJWDguk-wBB4CFAGCtSd5PLpPM9-028nSu1Dm-2zs_u3ONF-XH88YIEAia6Qe2Xz/pub?gid=898092456&single=true&output=csv";
    const REFRESH_MIN   = 5;
    ...
    function caricaCSV(callback) {
        GM_xmlhttpRequest({
            ...
            onload: function (res) {
                ...
                console.log("Trova LDC v15.02: DB pronto — " + db.rows.length + " righe.");
                if (callback) callback();
            },
            onerror: () => console.error("Trova LDC v15.02: Errore CSV.")
        });
    }
    ...
    function elaboraTabella() {
        ...
        document.querySelectorAll('tr.list_row, tr.list_odd, tr.list_even').forEach(riga => {
            ...
            if (rigaDb) {
                ...
                btnQR.onmouseover = () => btnQR.style.setProperty("background", "#cc0000",  "important") || btnQR.style.setProperty("color", "white", "important") || btnQR.style.setProperty("border-color", "#cc0000", "important");
                btnQR.onmouseout  = () => btnQR.style.setProperty("background", "#f0f0ee",  "important") || btnQR.style.setProperty("color", "#333", "important") || btnQR.style.setProperty("border-color", "#c0bdb7", "important");
